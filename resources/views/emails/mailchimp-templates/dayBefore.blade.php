                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top"
                                                                ...
                                                                <a href="http://www.codestartacademy.com" title=""
                                                                   class="" target="_blank">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <h1><span style="font-size:30px">Our webinar is tomorrow!</span>
                                                                </h1>
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top"
                                                                ...
                                                                <a href="{{$zoom_url}}" title="" class=""
                                                                   target="_blank">
                                                                    <img align="center" alt=""
                                                                         src="https://gallery.mailchimp.com/964a8255a17bc18be34c64d59/images/9e2139f9-2512-4ec2-8359-29d5de518c51.jpg"
                                                                         width="564"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent"
                                                                ...
                                                                <a class="mcnButton " title="Join Webinar"
                                                                   href="{{$zoom_url}}" target="_blank"
                                                                   style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Join
                                                                    Webinar</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <p><span style="color:#000000">Hi </span>*|FNAME|*<span
                                                                    ...
                                                                    <br>
                                                                    <span style="color:#000000">Just a reminder our online webinar is one day away on {{ $date->format('F jS \a\t h:ia T') }}.<br>
<br>
...
<br>
Thanks,<br>
Dan from&nbsp;</span><a href="http://www.codestartacademy.com" target="_blank">Codestart Academy</a></p>
